...
class ComprasnetPublicacoesContrato extends ComprasnetCommand
{
     ...
     * @var string
     */
    protected $signature = 'comprasnet:publicacoes
     ...
     * @var string
     */
    protected $description = 'Importar Publicações de um Contrato';
    ...
    public function handle()
    {
        try {
            ...
            if (!$contrato) {
                ...
                $this->line('');
                $this->warn('Busque os dados do contrato antes de importar o publicações:');
                $this->warn('');
